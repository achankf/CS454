...
int main()
{
	...
	assert(rpcRegister("111111122222222333333334444444455555555666666667777777788888888", NULL, NULL) == FUNCTION_ARGS_ARE_INVALID);
	assert(rpcRegister("bad1", NULL, NULL) == FUNCTION_ARGS_ARE_INVALID);
