...
private: // methods
	...
	int suggest_helper(Postman &postman, const Function &func, unsigned &ret, bool is_binder);
...
public: // methods
	...
	int suggest(Postman &postman, const Function &func, unsigned &ret, bool is_binder);
